...
def polynomial_features(X: Tensor, degree: int = 2, interaction_only: bool = False, include_bias: bool = True) -> Tensor:
    ...
    # Security check: Calculate expected output size to prevent DoS
    ...
    if expected_features > 100000:
        raise ValueError(f"PolynomialFeatures output too large: {expected_features} features. Limit is 100000.")
