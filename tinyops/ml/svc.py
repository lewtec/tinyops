...
def svc(
    ...
    """
    Computes the decision function of a kernel Support Vector Classification.
    This is a stateless function that replicates the decision_function method
    of a trained sklearn.svm.SVC model.
    """
    if gamma == "scale":
