...
# Import the security limit from the decoder to ensure symmetrical validation.
from .decode_wav import MAX_WAV_FRAMES
...
def encode_wav(tensor: Tensor, sample_rate: int, sampwidth: int = 2) -> bytes:
  ...
  # Symmetrical check to what's in decode_wav. Prevents allocating
  # massive memory for a WAV file with an excessive number of frames.
