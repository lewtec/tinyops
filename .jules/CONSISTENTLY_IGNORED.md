...
**- Justification:** Mass refactoring of existing top-level imports to local imports across modules (e.g., `tinyops/ml`) is considered unwanted noise/churn, as seen in rejected PR #206. While reducing import time is good, mass changes like this are disruptive.
